...
export const metadata: Metadata = {
  title: "Aline's Slimes - Premium Handcrafted Slimes in Madrid",
  description: "Discover amazing handcrafted slimes by Aline in Madrid. Choose from Basic, Premium, and Ultra collections. Made with love and premium ingredients.",
  keywords: "slime, handcrafted slimes, Madrid, premium slime, basic slime, ultra slime, Aline slimes",
  openGraph: {
    title: "Aline's Slimes - Premium Handcrafted Slimes in Madrid",
    description: "Discover amazing handcrafted slimes by Aline in Madrid. Choose from Basic, Premium, and Ultra collections.",
    siteName: "Aline's Slimes",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763219850857-ux37a3xs.jpg",
        alt: "Colorful premium slime collection"
      }
    ]
  },
  twitter: {
    ...
    title: "Aline's Slimes - Premium Handcrafted Slimes in Madrid",
    description: "Discover amazing handcrafted slimes by Aline in Madrid. Choose from Basic, Premium, and Ultra collections.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763219850857-ux37a3xs.jpg"]
  },
  robots: {
    index: true,
    follow: true
